...
import ConnectHeadsetNeurocity from "./ConnectHeadsetNeurocity";

class NFTData2 extends Component {
    ...
    render() {
        if (this.state.metawiseNFTTotalSupply > 5) {
            return (
                // <tokenData/>
                <ConnectHeadsetNeurocity/>
            )
        } else {
